        ...
        <div className="grid gap-6 lg:grid-cols-3">
          ...
          >
            {webinars?.showThankYouPage ? (
              <div className="rounded-lg bg-white p-8 shadow-lg">
                <div className="text-center">
                  ...
                  <p className="mb-6 text-lg text-gray-600">
                    We appreciate your participation in this webinar. The
                  ...
                  <div className="rounded-lg bg-gray-50 p-4">
                    ...
                    <ul className="text-left text-gray-600">
                      <li className="mb-1">
                        • You&apos;ll receive a recording link via email
                      </li>
                      <li className="mb-1">
                        • Check your dashboard for additional resources
                      </li>
                      <li className="mb-1">
              ...
              <CustomVideoPlayer
                videoUrl={
                  webinars?.youtubeLink || webinars?.video?.url || videoUrl
                }
              />
            )}
          </motion.div>

...
const WebinarkitSectionBuild = () => {
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-blue-50 to-white px-6 py-20 md:px-16 dark:from-slate-800 dark:to-gray-900">
      {/* Background decorative elements */}
      <div className="absolute -left-20 top-20 size-80 rounded-full bg-blue-100 opacity-30 blur-3xl dark:bg-blue-900/50 dark:opacity-20"></div>
      <div className="absolute -bottom-20 -right-20 size-80 rounded-full bg-indigo-100 opacity-30 blur-3xl dark:bg-indigo-900/50 dark:opacity-20"></div>
      ...
      <div className="relative flex flex-col items-start justify-between gap-12 md:flex-row">
        ...
        >
          ...
          >
            <Link
              href="#pricing"
              className="group inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-blue-600 to-indigo-600 px-6 py-3 text-sm font-semibold text-white shadow-md transition-all duration-300 hover:shadow-lg hover:shadow-blue-500/30 dark:from-blue-500 dark:to-indigo-500 dark:hover:shadow-blue-400/30"
            >
              Explore all plans

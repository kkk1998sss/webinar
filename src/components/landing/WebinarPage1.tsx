...
export default function WebinarPage1() {
  return (
    <motion.div
      className="bg-gradient-to-b from-white to-blue-50 py-16 text-gray-900"
      initial={{ opacity: 0 }}
    ...
    >
      <div className="container mx-auto flex flex-col items-center justify-between px-4 lg:flex-row lg:px-8">
        ...
        >
          ...
          >
            <motion.button
              className="rounded-full bg-gradient-to-r from-blue-600 to-purple-600 px-8 py-3 text-lg text-white shadow-lg transition-all duration-300 hover:scale-105 hover:shadow-xl"
        ...
        >
          <div className="relative h-[280px] w-[420px] sm:h-[320px] sm:w-[480px] md:h-[360px] md:w-[520px]">
            <motion.div
              className="absolute -inset-1 rounded-xl bg-gradient-to-r from-blue-500 to-purple-500 opacity-20 blur"
              animate={{
                opacity: [0.2, 0.3, 0.2],
                scale: [1, 1.02, 1],
              }}
            ...
            <div className="relative size-full overflow-hidden rounded-xl shadow-2xl">
              ...
              <motion.button
                className="absolute left-1/2 top-1/2 flex size-16 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full bg-gradient-to-r from-blue-600 to-purple-600 text-white shadow-lg"
      ...
      <motion.div
        className="mt-16 rounded-xl bg-white py-8 shadow-md"
      ...
      >
        <div className="container mx-auto flex flex-wrap items-center justify-between px-4 lg:px-8">
          ...
          >
            ...
            <span className="ml-1 bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text font-bold text-transparent">
              18,000+ businesses
            </span>
          </motion.div>
